package com.example.dogwatch.security;
...
import com.example.dogwatch.pages.Login;
...
public class AuthenticationFilter implements ComponentRequestFilter
{
    ...
    {
        Link link = renderLinkSource.createPageRenderLinkWithContext(Login.class, targetPageName);
